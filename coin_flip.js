...
function coinFlip() {
  ...
  function fallingCoins(){
    ...
    if (heads_wins.length > tails_wins.length){
      document.getElementById("damn").innerHTML += "<div id='coin_fall'><img id='falling_coin' src='images/falling_quarter_head.png'/></div>"
    } else {
      document.getElementById("damn").innerHTML += "<div id='coin_fall'><img id='falling_coin' src='images/falling_quarter_tails.png'/></div>"
    }
